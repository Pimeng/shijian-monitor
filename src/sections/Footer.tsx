    ...
    >
      <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-xs text-muted-foreground">
        <div className="flex items-center gap-1.5">
          <span>数据来自</span>
          <span className="text-foreground/60 font-medium">vivo 健康</span>
          <span>·</span>
          <span className="text-foreground/60 font-medium">皮梦视奸网</span>
        </div>
      ...
      <div className="mt-4 flex items-center justify-center gap-1 text-[10px] text-muted-foreground/60">
        <span>Made with</span>
        <Heart size={10} className="text-red-500/60 dark:text-red-400/60 fill-red-500/60 dark:fill-red-400/60" />
        <span>for 皮梦</span>
      </div>
    </motion.footer>
  );
